...
enum HeaderFormat
{
    ...
    HEADER_FORMAT_MPEG  = SF_FORMAT_MPEG,
};
#endc
...
enum SampleFormat
{
    ...
    HEADER_FORMAT_MPEG_LAYER_I      = SF_FORMAT_MPEG_LAYER_I,
    HEADER_FORMAT_MPEG_LAYER_II     = SF_FORMAT_MPEG_LAYER_II,
    HEADER_FORMAT_MPEG_LAYER_III    = SF_FORMAT_MPEG_LAYER_III,
};
#endc
